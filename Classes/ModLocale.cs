...
public class Localization
{
	...
	public static class Items
	{
		...
		SET_SUNLIGHTSHADOWS_ENTRY = "SET_SUNLIGHTSHADOWS_ENTRY", SET_GAIADETAIL_ENTRY = "SET_GAIADETAIL_ENTRY",
	...
	private readonly static Dictionary<string, string> englishDict = new()
	{
		...
		{Items.SET_SUNLIGHTSHADOWS_ENTRY, "Sunlight shadow casting"},
		{Items.SET_GAIADETAIL_ENTRY, "GAIA Detail Manager"},
